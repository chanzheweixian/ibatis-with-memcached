...
public class SqlMapConfiguration {
  ...
  private void registerDefaultTypeAliases() {
    ...
    // use a string for Memcached to avoid unnecessary loading of properties upon init
    typeHandlerFactory.putTypeAlias("MEMCACHED", "com.ibatis.sqlmap.engine.cache.memcached.MemcachedController");
