...
public class MappedStatement {
  ...
  public int executeUpdate(StatementScope statementScope, Transaction trans, Object parameterObject)
    ...
    try {
      ...
      notifyListeners(statementScope,parameterObject);
      return rows;
  ...
  public void notifyListeners(StatementScope statementScope, Object parameterObject) {
	  CacheKey cacheKey = getCacheKey(statementScope, parameterObject);
    for (int i = 0, n = executeListeners.size(); i < n; i++) {
      ((ExecuteListener) executeListeners.get(i)).onExecuteStatement(this,cacheKey);
    }
  }
